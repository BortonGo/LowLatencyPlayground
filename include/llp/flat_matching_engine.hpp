...
namespace llp {
    ...
    class FlatMatchingEngine {
        llp::PriceLevelArrayBookSide<OrderSide::Buy> buy;
        llp::PriceLevelArrayBookSide<OrderSide::Sell> sell;
    public:
        FlatMatchingEngine(std::size_t min_price, std::size_t max_price) : buy(min_price, max_price),
                           sell(min_price, max_price) {}
